 ...
 */
@ConvertAsProperties(dtd = "-//es.regueiro.easyrepair.ui.stock//PartOrderInvoiceBrowser//EN",
autostore = false)
@TopComponent.Description(preferredID = "PartOrderInvoiceBrowserTopComponent",
iconBase = "es/regueiro/easyrepair/ui/stock/icons/invoice.png",
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(position = 18, mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "es.regueiro.easyrepair.ui.stock.PartOrderInvoiceBrowserTopComponent")
@ActionReferences({
    @ActionReference(path = "Menu/Piezas", position = 2),
    @ActionReference(path = "Toolbars/Piezas", position = 2)
})
@TopComponent.OpenActionRegistration(displayName = "#CTL_PartOrderInvoiceBrowserAction",
preferredID = "PartOrderInvoiceBrowserTopComponent")
@Messages({
    "CTL_PartOrderInvoiceBrowserAction=Buscador de facturas de pedidos",
    "CTL_PartOrderInvoiceBrowserTopComponent=Buscador de facturas de pedidos",
    "HINT_PartOrderInvoiceBrowserTopComponent=Esta es una ventana del buscador de facturas de pedidos"
})
public final class PartOrderInvoiceBrowserTopComponent extends TopComponent implements TableModelListener, ListSelectionListener {

    private PartOrderInvoiceTableModel model = new PartOrderInvoiceTableModel();
    private InstanceContent content = new InstanceContent();
    private PartOrderInvoiceController controller = Lookup.getDefault().lookup(PartOrderInvoiceController.class);
    private PartOrderInvoice invoice;
    private PartOrderInvoiceLookup lookup = PartOrderInvoiceLookup.getDefault();
    private PartOrderLookup orderLookup = PartOrderLookup.getDefault();
    private final JDatePickerImpl dateSearchFromDatePicker;
    private final JDatePickerImpl dateSearchToDatePicker;

    public PartOrderInvoiceBrowserTopComponent() {
        initComponents();
        setName(Bundle.CTL_PartOrderInvoiceBrowserTopComponent());
        setToolTipText(Bundle.HINT_PartOrderInvoiceBrowserTopComponent());
        this.setFocusable(true);

        String[] inCBStrings = {java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("INVOICENUMBER"),
            java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("INVOICEDATE"),
            java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("ACCEPTEDDATE"),
            java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("ESTIMATEDPAYMENTDATE"),
            java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("PAYMENTDATE"),
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(searchLabel, org.openide.util.NbBundle.getMessage(PartOrderInvoiceBrowserTopComponent.class, "PartOrderInvoiceBrowserTopComponent.searchLabel.text_1")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(inLabel, org.openide.util.NbBundle.getMessage(PartOrderInvoiceBrowserTopComponent.class, "PartOrderInvoiceBrowserTopComponent.inLabel.text_1")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(listAllButton, org.openide.util.NbBundle.getMessage(PartOrderInvoiceBrowserTopComponent.class, "PartOrderInvoiceBrowserTopComponent.listAllButton.text_1")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(dateSearchFromLabel, org.openide.util.NbBundle.getMessage(PartOrderInvoiceBrowserTopComponent.class, "PartOrderInvoiceBrowserTopComponent.dateSearchFromLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        dateSearchPanel.add(dateSearchFromLabel, gridBagConstraints);

        org.openide.awt.Mnemonics.setLocalizedText(dateSearchToLabel, org.openide.util.NbBundle.getMessage(PartOrderInvoiceBrowserTopComponent.class, "PartOrderInvoiceBrowserTopComponent.dateSearchToLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        org.openide.awt.Mnemonics.setLocalizedText(includeDisabledCheckBox, org.openide.util.NbBundle.getMessage(PartOrderInvoiceBrowserTopComponent.class, "PartOrderInvoiceBrowserTopComponent.includeDisabledCheckBox.text_1")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(findButton, org.openide.util.NbBundle.getMessage(PartOrderInvoiceBrowserTopComponent.class, "PartOrderInvoiceBrowserTopComponent.findButton.text_1")); // NOI18N
        ...
        detailedViewButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/es/regueiro/easyrepair/ui/stock/icons/invoice_detailed.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(detailedViewButton, org.openide.util.NbBundle.getMessage(PartOrderInvoiceBrowserTopComponent.class, "PartOrderInvoiceBrowserTopComponent.detailedViewButton.text_1")); // NOI18N
        ...
        editInvoiceButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/es/regueiro/easyrepair/ui/stock/icons/invoice_edit.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(editInvoiceButton, org.openide.util.NbBundle.getMessage(PartOrderInvoiceBrowserTopComponent.class, "PartOrderInvoiceBrowserTopComponent.editInvoiceButton.text")); // NOI18N
        ...
        printSelectedInvoiceButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/es/regueiro/easyrepair/ui/stock/icons/printer.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(printSelectedInvoiceButton, org.openide.util.NbBundle.getMessage(PartOrderInvoiceBrowserTopComponent.class, "PartOrderInvoiceBrowserTopComponent.printSelectedInvoiceButton.text")); // NOI18N
        ...
        printInvoiceListButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/es/regueiro/easyrepair/ui/stock/icons/printer.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(printInvoiceListButton, org.openide.util.NbBundle.getMessage(PartOrderInvoiceBrowserTopComponent.class, "PartOrderInvoiceBrowserTopComponent.printInvoiceListButton.text_1")); // NOI18N
    ...
    private void detailedViewButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detailedViewButtonActionPerformed
        ...
        ((PartOrderDetailedViewTopComponent) window).viewInvoice(invoice);
    ...
    private void printInvoiceListButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printInvoiceListButtonActionPerformed
        ...
        final SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() {
                ...
                printer.printPartOrderInvoiceList(model.getPartOrderInvoiceList());
                return null;
            }
        };
        worker.execute();
    ...
    private void printSelectedInvoiceButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printSelectedInvoiceButtonActionPerformed
        final SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() {
                ReportPrinter printer = new ReportPrinter();
                printer.printPartOrderInvoice(invoice);
                return null;
            }
        };
        worker.execute();
...
//            editInvoiceButton.setEnabled(SecurityManager.getDefault().userHasPrivilege(Privilege.REPAIR_INVOICE_EDIT));
    ...
    public void valueChanged(ListSelectionEvent event) {
        if (!event.getValueIsAdjusting()) {
            if (invoiceTable.getSelectedRow() > -1) {
                ...
                lookup.setOrderInvoice(invoice);
                orderLookup.setPartOrder(invoice.getOrder());
            } else {
                editInvoiceButton.setEnabled(false);
                printSelectedInvoiceButton.setEnabled(false);
            }
    ...
    private void openInvoiceView() {
        ...
        window.open();
        window.requestActive();
        ((PartOrderEditorTopComponent) window).viewInvoice(invoice);
    }
    ...
    private void doSearch() {
        ...
        final SwingWorker<List<PartOrderInvoice>, Void> worker = new SwingWorker<List<PartOrderInvoice>, Void>() {
            private int column;
            ...
            protected void done() {
                try {
                    List<PartOrderInvoice> list = get();
                    model.fill(list);
            ...
            protected List<PartOrderInvoice> doInBackground() {
                ...
                if (!includeDisabledCheckBox.isSelected()) {
                    Iterator<PartOrderInvoice> iterator = list.iterator();
                    while (iterator.hasNext()) {
                        PartOrderInvoice v = iterator.next();
                        if (!v.getEnabled()) {
                            iterator.remove();
                        }
                    }
    ...
    private void doListAll() {
        ...
        final ProgressHandle p = ProgressHandleFactory.createHandle(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("LISTING_ALL_X"), java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("INVOICES")));

        SwingWorker<List<PartOrderInvoice>, Void> worker = new SwingWorker<List<PartOrderInvoice>, Void>() {
            @Override
            protected void done() {
                try {
                    List<PartOrderInvoice> list = get();
            ...
            @Override
            protected List<PartOrderInvoice> doInBackground() {
                List<PartOrderInvoice> list = controller.listAll();
    ...
    public void deleteInvoice(PartOrderInvoice veh) {
        if (invoice != null && veh.getId().equals(invoice.getId())) {
            invoice = null;
            StatusDisplayer.getDefault().setStatusText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("X_DELETED"), java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("INVOICE")));
            lookup.clear();

        }

        model.removeOrderInvoice(veh);
        ...
        inCombobox.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    ...
                    if (item.equals(java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("INVOICENUMBER"))) {
                        textSearchPanel.setVisible(true);
                        dateSearchPanel.setVisible(false);
                    }
                    if (item.equals(java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("INVOICEDATE"))) {
                        textSearchPanel.setVisible(false);
                        dateSearchPanel.setVisible(true);
                    }
                    if (item.equals(java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("ACCEPTEDDATE"))) {
                        textSearchPanel.setVisible(false);
                        dateSearchPanel.setVisible(true);
                    }
                    if (item.equals(java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("ESTIMATEDPAYMENTDATE"))) {
                        textSearchPanel.setVisible(false);
                        dateSearchPanel.setVisible(true);
                    }
                    if (item.equals(java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("PAYMENTDATE"))) {
                        textSearchPanel.setVisible(false);
                        dateSearchPanel.setVisible(true);
                    }
                    if (item.equals(java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("PAYMENTMETHOD"))) {
                        textSearchPanel.setVisible(true);
                        dateSearchPanel.setVisible(false);
                    }
                    if (item.equals(java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("STATUS"))) {
                        textSearchPanel.setVisible(true);
                        dateSearchPanel.setVisible(false);
                    }
                    if (item.equals(java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("RESPONSIBLE"))) {
                        textSearchPanel.setVisible(true);
                        dateSearchPanel.setVisible(false);
                    }
                }
