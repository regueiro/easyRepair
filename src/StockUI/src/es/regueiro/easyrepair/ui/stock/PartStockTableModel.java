...
public class PartStockTableModel extends AbstractTableModel {
    ...
    public void setValueAt(Object value, int rowIndex, int columnIndex) {
        String stringUnits = (String) value;
        try {
            int units = Integer.parseInt(stringUnits);
            switch (columnIndex) {
                case 2:
                    data.get(rowIndex).setUnits(units);
            ...
            NotifyDescriptor d = new NotifyDescriptor.Message(
                    java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("X_INVALID"), java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("UNIT")), NotifyDescriptor.WARNING_MESSAGE);
