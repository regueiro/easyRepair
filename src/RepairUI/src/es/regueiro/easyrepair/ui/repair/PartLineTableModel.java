...
public class PartLineTableModel extends AbstractTableModel {
    ...
    public String getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 3:
                return data.get(rowIndex).getPart().getPrice().toPlainString();
            case 4:
    ...
    public void setValueAt(Object value, int rowIndex, int columnIndex) {
        ...
        try {
            ...
            NotifyDescriptor d = new NotifyDescriptor.Message(
                    java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("X_INVALID"), java.util.ResourceBundle.getBundle("es/regueiro/easyrepair/ui/stock/Bundle").getString("VALUE")), NotifyDescriptor.WARNING_MESSAGE);
