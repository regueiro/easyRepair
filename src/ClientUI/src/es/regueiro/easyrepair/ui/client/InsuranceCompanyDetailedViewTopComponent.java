 ...
 */
@ConvertAsProperties(dtd = "-//es.regueiro.easyrepair.ui.client//InsuranceCompanyDetailedView//EN",
autostore = false)
@TopComponent.Description(iconBase = "es/regueiro/easyrepair/ui/client/icons/mechanic_detailed.png", preferredID = "InsuranceCompanyDetailedViewTopComponent",
//iconBase="SET/PATH/TO/ICON/HERE", 
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(position = 2, mode = "explorer", openAtStartup = false)
@ActionID(category = "Window", id = "es.regueiro.easyrepair.ui.client.InsuranceCompanyDetailedViewTopComponent")
@TopComponent.OpenActionRegistration(displayName = "#CTL_InsuranceCompanyDetailedViewAction",
preferredID = "InsuranceCompanyDetailedViewTopComponent")
@Messages({
    "CTL_InsuranceCompanyDetailedViewAction=Vista detallada de aseguradoras",
    "CTL_InsuranceCompanyDetailedViewTopComponent=Vista detallada de aseguradoras",
    "HINT_InsuranceCompanyDetailedViewTopComponent=Esta es una ventana de la vista detallada de aseguradoras"
})
public final class InsuranceCompanyDetailedViewTopComponent extends TopComponent implements LookupListener {

    private Lookup.Result<InsuranceCompany> result = null;
    private InsuranceCompany insuranceCompany;
    private PhoneNumberUtil phoneUtil = PhoneNumberUtil.getInstance();

    public InsuranceCompanyDetailedViewTopComponent() {
        initComponents();
        setName(Bundle.CTL_InsuranceCompanyDetailedViewTopComponent());
        setToolTipText(Bundle.HINT_InsuranceCompanyDetailedViewTopComponent());
        ...
        extendedDataTabbedPane.setIconAt(3, new javax.swing.ImageIcon(getClass().getResource("/es/regueiro/easyrepair/ui/client/icons/document_notes.png")));
    }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(webLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.webLabel.text")); // NOI18N
        webLabel.setPreferredSize(new java.awt.Dimension(80, 14));
        ...
        org.openide.awt.Mnemonics.setLocalizedText(nameLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.nameLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(nifLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.nifLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(tittleLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.tittleLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(idLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.idLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(printButton, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.printButton.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(addressLabelLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.addressLabelLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(addressStreetLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.addressStreetLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(addressCityLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.addressCityLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(addressProvinceLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.addressProvinceLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(addressPostalCodeLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.addressPostalCodeLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(addressCountryLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.addressCountryLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(addressNotesLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.addressNotesLabel.text")); // NOI18N
        ...
        extendedDataTabbedPane.addTab(org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.addressPanel.TabConstraints.tabTitle"), addressPanel); // NOI18N

        emailPanel.setLayout(new java.awt.GridBagLayout());

        org.openide.awt.Mnemonics.setLocalizedText(emailLabelLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.emailLabelLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(emailAddressLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.emailAddressLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(emailNotesLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.emailNotesLabel.text")); // NOI18N
        ...
        extendedDataTabbedPane.addTab(org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.emailPanel.TabConstraints.tabTitle"), emailPanel); // NOI18N

        phonePanel.setLayout(new java.awt.GridBagLayout());

        org.openide.awt.Mnemonics.setLocalizedText(phoneLabelLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.phoneLabelLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(phoneNumberLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.phoneNumberLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(phoneNotesLabel, org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.phoneNotesLabel.text")); // NOI18N
        ...
        extendedDataTabbedPane.addTab(org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.phonePanel.TabConstraints.tabTitle"), phonePanel); // NOI18N
        ...
        extendedDataTabbedPane.addTab(org.openide.util.NbBundle.getMessage(InsuranceCompanyDetailedViewTopComponent.class, "InsuranceCompanyDetailedViewTopComponent.notesPanel.TabConstraints.tabTitle"), notesPanel); // NOI18N
    ...
    public HelpCtx getHelpCtx() {
        ...
        return new HelpCtx("es.regueiro.easyrepair.ui.insuranceCompany.detailed");
    }
    ...
    private void fillData() {
        Collection<? extends InsuranceCompany> insuranceCompanyCol = result.allInstances();
        if (!insuranceCompanyCol.isEmpty()) {
            InsuranceCompany tempInsuranceCompany = insuranceCompanyCol.iterator().next();
            if (insuranceCompany != tempInsuranceCompany) {
                insuranceCompany = tempInsuranceCompany;
                clearGeneral();
                clearNotes();
