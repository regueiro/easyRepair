...
public class Templates {
     ...
     * component
     */
    public static ComponentBuilder<?, ?> createTitleComponent(String label, String number) {
        return cmp.horizontalList()
                .add(
                ShopReport.generateShopData(),
                cmp.verticalList(
                cmp.text(label).setStyle(bold18CenteredStyle).setHorizontalAlignment(HorizontalAlignment.RIGHT),
                cmp.text(number).setStyle(bold22CenteredStyle).setHorizontalAlignment(HorizontalAlignment.RIGHT)))
                .newRow()
                .add(cmp.line())
                .newRow()
