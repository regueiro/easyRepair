 ...
 * @author Santi
 */
public class PartOrderInvoiceTest {

    public PartOrderInvoiceTest() {
    }
    ...
    /**
     * Test of getEnabled method, of class PartOrderInvoice.
     */
    @Test
    public void testPartOrderInvoice() {
        System.out.println("Testing Part Order Invoice Components");
        
        PartOrder ord = new PartOrder();
        PartOrderInvoice inv = ord.getInvoice();
        ...
        PartOrder ord2 = new PartOrder();
        Employee emp1 = new Employee();
        Employee emp2 = new Employee();
        emp1.setName("tio");

        PartOrderInvoice inv1 = ord1.getInvoice();
        PartOrderInvoice inv2 = ord2.getInvoice();
        ord1.setNotes("not");
